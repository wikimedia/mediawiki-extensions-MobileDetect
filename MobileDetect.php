...
// MobileDetect Script (Mediawiki Extension Package)
// version: 1.0
// status: beta
// tested: MediaWiki 1.16.0
// description: returns false if not a mobile browser, true if it is.
//              should be a universal script. (works on all mediawiki versions)
...
$wgExtensionCredits['parserhook'][] = array(
        ...
        'author'        =>      'Matthew Tran',
        'url'           =>      'http://www.mediawiki.org/wiki/Extension:MobileDetect',
        'description'   =>      'Detects mobile devices and returns true or false depending on browsers user agent.'
);
